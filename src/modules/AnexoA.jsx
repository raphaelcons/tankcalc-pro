...
import anexoA from "./utils/anexoA";
...
export default function renderAnexoA() {
    ...
    <div className="p-6 flex bg-gray-100 min-h-screen">
      ...
      <div className="bg-white p-6 shadow-lg space-y-6 w-screen">
        <h1 className="text-4xl font-bold text-center">
          TankCalc Pro - Espessura Costado - Método Anexo A
        </h1>
        <Toggle
